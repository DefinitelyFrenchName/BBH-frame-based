...
DEFAULTS = {
    ...
    "sweep": {
        ...
        "placeholders": {"MERGED": "build/m3b_merged27", "DON": "build/don_m23", "HUI": "build/hui57",
                         "PYR": "build/pyron42", "STOCK": "build/m5_stock18"},   # %NAME%; env NAME= overrides
    ...
    "inp": {
        ...
        "build": "build/m3b_merged27",                # the build dir under test (env BUILD / --build override)
