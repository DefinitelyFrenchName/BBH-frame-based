...
DEFAULTS = {
    ...
    "sweep": {
        ...
        "placeholders": {"MERGED": "build/m3b_merged28", "DON": "build/don_m24", "HUI": "build/hui58",
                         "PYR": "build/pyron43", "STOCK": "build/m5_stock19"},   # %NAME%; env NAME= overrides
    ...
    "inp": {
        ...
        "build": "build/m3b_merged28",                # the build dir under test (env BUILD / --build override)
